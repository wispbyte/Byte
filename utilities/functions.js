...
class ChannelLocking {
    ...
    static getLockdownableChannels(guild) {
        ...
        for (const [_, channel] of guild.channels.cache) {
            if (channel.isDMBased() || channel.type === ChannelType.GuildCategory || channel.type === ChannelType.GuildDirectory || !channel.permissionsFor(channel.guild.roles.everyone).has(PermissionFlagsBits.ViewChannel | PermissionFlagsBits.SendMessages))
                continue; //Not public viewable and / or writable channel
