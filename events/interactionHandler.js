    ...
    async execute(interaction, client) {
        if (interaction.isButton()) {
            ...
            try {
                ...
                console.error(err);
                interaction.deferred || interaction.replied ?
                    interaction.followUp({ content: 'There was an error executing this command', flags: MessageFlags.Ephemeral }) :
                    interaction.reply({ content: 'There was an error executing this command', flags: MessageFlags.Ephemeral }); // reply in the appropriate manner depending on what has happened
            }
        }
    },
};